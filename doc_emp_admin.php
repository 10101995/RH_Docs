    ...
    <div class="uk-grid-large" data-uk-grid>
      <div class="sidebar-fixed-width uk-visible@m">
        <div class="sidebar-docs uk-position-fixed uk-margin-top">
          ...
          <ul class="uk-nav uk-nav-default doc-nav">
            ...
            <li class="uk-active"><a href="doc_emp_admin.php">Employés</a></li>
            <li><a href="doc_type_conge">Types de congés</a></li>
      ...
      <div class="uk-width-1-1 uk-width-expand@m">
        ...
        <!-- <h2 id="image-lightbox-example">Espace employés Gestion RH</h2> -->
             <p>Dans le sous ménu de "EMPLOYES" se trouve l'option "Ajouter un employé" , vous avez juste a remplir les champs et enregistrer l'employé
          </p>
          <!-- <ul class="uk-list link-secondary">
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/rh-admin-ajout-employe.jpg" data-caption="Image in lightbox">
                <img src="images/rh-admin-ajout-employe.jpg" alt="Alt for image">
       ...
       <div>
        <!-- <h2 id="image-lightbox-example">Espace employés Gestion RH</h2> -->
             <p>Dans le sous ménu de "EMPLOYES" se trouve La liste des employés
          </p>
          <!-- <ul class="uk-list link-secondary">
              <li><a href="#">Employé Connexion</a></li>
              <li><a href="#">Admin Connexion</a></li>
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/rh-admin-employe-list.jpg" data-caption="Image in lightbox">
                <img src="images/rh-admin-employe-list.jpg" alt="Alt for image">
                <div class="uk-position-center">
                  <span data-uk-overlay-icon></span>
                </div>
              </a>
