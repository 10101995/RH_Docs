    ...
    <div class="uk-grid-large" data-uk-grid>
      <div class="sidebar-fixed-width uk-visible@m">
        <div class="sidebar-docs uk-position-fixed uk-margin-top">
          ...
          <ul class="uk-nav uk-nav-default doc-nav">
            ...
            <li class="uk-active"><a href="doc_type_conge.php">Types de congés</a></li>
      ...
      <div class="uk-width-1-1 uk-width-expand@m">
        ...
        <!-- <h2 id="image-lightbox-example">Espace employés Gestion RH</h2> -->
             <p>Dans le sous ménu de "TYPE DE CONGES" se trouve l'option "Ajouter un type de congé" , vous avez juste a remplir les champs et enregistrer le type de congé
          </p>
          <!-- <ul class="uk-list link-secondary">
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/rh-admin-ajout-type-congé.jpg" data-caption="Image in lightbox">
                <img src="images/rh-admin-ajout-type-congé.jpg" alt="Alt for image">
       ...
       <div>
        <!-- <h2 id="image-lightbox-example">Espace employés Gestion RH</h2> -->
             <p>Dans le sous ménu de "TYPE DE CONGES" se trouve La gestion des types de congés
          </p>
          <!-- <ul class="uk-list link-secondary">
              <li><a href="#">Employé Connexion</a></li>
              <li><a href="#">Admin Connexion</a></li>
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/rh-admin-type-congé-list.jpg" data-caption="Image in lightbox">
                <img src="images/rh-admin-type-congé-list.jpg" alt="Alt for image">
                <div class="uk-position-center">
                  <span data-uk-overlay-icon></span>
                </div>
              </a>
