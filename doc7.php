...
<div class="uk-section">
  <div class="uk-container">
    <div class="uk-grid-large" data-uk-grid>
      <div class="sidebar-fixed-width uk-visible@m">
        <div class="sidebar-docs uk-position-fixed uk-margin-top">
          ...
          <ul class="uk-nav uk-nav-default doc-nav">
            <li class="uk-active"><a href="doc.html">Accueil</a></li>
          </ul>
          <h5>Partie Employés</h5>
          <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="doc.php">Espace employé</a></li>
      ...
      <div>
        <h2 id="image-lightbox-example">Accueil Gestion RH</h2>
            <p>Vous serez dirigé vers cet interface de connexion pour la première fois. <br>
                Vous avez le choix de vous connectez en tant qu'administrateur ou employé.
          </p>
          <ul class="uk-list link-secondary">
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/rh-accueil.jpg" data-caption="Image in lightbox">
                <img src="images/rh-accueil.jpg" alt="Alt for image">
          ...
          <div class="article-content link-primary">
            ...
            <h2 id="image-lightbox-example">Informations des employés</h2>
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/employe1.jpg" data-caption="Image in lightbox">
                <img src="images/employe1.jpg" alt="Alt for image">
                <div class="uk-position-center">
                  <span data-uk-overlay-icon></span>
                </div>
              </a>
          ...
          <div class="uk-margin-large-top paginate-post">
            <div class="uk-child-width-expand@s uk-grid-large" data-uk-grid>
              ...
              <div>
                ...
                <div class="uk-text-right"><a class="remove-underline hvr-forward" href="doc.php">Next →</a></div>
              </div>
            </div>
          </div>
