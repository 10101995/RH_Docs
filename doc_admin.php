    ...
    <div class="uk-grid-large" data-uk-grid>
      <div class="sidebar-fixed-width uk-visible@m">
        <div class="sidebar-docs uk-position-fixed uk-margin-top">
          ...
          <h5>Partie Admin</h5>
          <ul class="uk-nav uk-nav-default doc-nav">
            <li class="uk-active"><a href="doc_admin.php">Dashboard</a></li>
      ...
      <div class="uk-width-1-1 uk-width-expand@m">
        ...
        <!-- <h2 id="image-lightbox-example">Espace employés Gestion RH</h2> -->
             <p>Nous avons sur le "DASHBOARD" Toutes les informations disponibles sur notre entreprise et les employés
          </p>
          <!-- <ul class="uk-list link-secondary">
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/rh-admin-dash.jpg" data-caption="Image in lightbox">
                <img src="images/rh-admin-dash.jpg" alt="Alt for image">
       ...
       <div>
        <!-- <h2 id="image-lightbox-example">Espace employés Gestion RH</h2> -->
             <p>Dans le menu "DEPARTEMENT" nous avons deux options "AJOUTER UNE FONCTION" et "LISTE DES FONCTIONS"
          </p>
          <!-- <ul class="uk-list link-secondary">
              <li><a href="#">Employé Connexion</a></li>
              <li><a href="#">Admin Connexion</a></li>
            ...
            <figure data-uk-lightbox="animation: slide">
              <a class="uk-inline" href="images/rh-admin-drop-depart.jpg" data-caption="Image in lightbox">
                <img src="images/rh-admin-drop-depart.jpg" alt="Alt for image">
                <div class="uk-position-center">
                  <span data-uk-overlay-icon></span>
                </div>
              </a>
